...
contract CryptoDevsDAO {
    ...
    //we need a way for people to become a member of DAO
   ...
   // Execute a proposal
    ...
    function quit() external memberOnly {
        ...
        require(block.timestamp - member.joinedAt > 5 minutes,
    ...
    //Receive and fallback function , these functions are good to hve for testing
